...
- **구성**: 총 **149 슬라이드**(139 → 141 → 145 → 149 감쇠 곡선 4장 추가). Introduction 20 / Preliminary Knowledge 18 / Simple Linear Regression 20 / Multiple Linear Regression 30 / Diagnosis & Variable Selection 18 / Weighted Regression 21 / Dummy Variable 13 / Summary 9. 렌더 HTML 기준 159장(장 표지 8 + 타이틀 2 포함). 관련: [[lecture-chapter-structure]]
- **강의 대본**: `::: notes` 157건(장 표지 포함, 전 슬라이드 수록).
