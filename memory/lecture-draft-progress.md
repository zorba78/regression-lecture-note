...
- **구성**: 총 **151 슬라이드**(139 → 141 → 145 → 149 → 151 최소제곱 타당성 2장 추가). Introduction 20 / Preliminary Knowledge 18 / Simple Linear Regression 22 / Multiple Linear Regression 30 / Diagnosis & Variable Selection 18 / Weighted Regression 21 / Dummy Variable 13 / Summary 9. 렌더 HTML 기준 161장(장 표지 8 + 타이틀 2 포함). 관련: [[lecture-chapter-structure]]
