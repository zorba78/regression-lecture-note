...
- [특강 진행 상황](lecture-draft-progress.md) — 2026-08-13 7장 재편본(139슬라이드) 현황과 산출물 위치
...
- [문체 규칙](slide-register-rule.md) — 본문 문어체 개조식 / 노트 경어체, AI 문투 제거
- [레이아웃 초과 검출법](slide-overflow-check.md) — 139장을 눈으로 넘기지 않고 자동 검출
